...
const ApplicationLayout: React.FC<Props> = async ({ children, header }) => {
  ...
  return (
    <Aside.Provider>
      ...
      <div className="relative z-20 hidden lg:block lg:px-20 px-4">{header ? header : <Header nationalDestinations={destinationNational} internationalDestinations={destinationInternational} voyage={category} nature={nature} navbarItems={navbarItem}/>}</div>
