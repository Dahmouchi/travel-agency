...
const tourSchema = z.object({
  ...
  isDiscover: z.boolean().default(false),
  difficultyLevel: z
...
export function AddTourForm({
  ...
  const form = useForm<z.infer<typeof tourSchema>>({
    defaultValues: {
      ...
      showChecklist: true, // Prisma default: true
                        ...
                        <FormItem>
                          <FormLabel>
                            ...
                            <span className="text-gray-600 text-sm">
                              (Cet identifiant unique sera utilisé dans
                              l&apos;URL de votre circuit et deviendra permanent
                              après création)
                            </span>
                          </FormLabel>
                          <FormControl>
