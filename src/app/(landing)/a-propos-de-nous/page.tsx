                  ...
                  <div className="section-reveal" ref={addToRefs}>
                    ...
                    <div className="space-y-6 lg:text-lg text-sm text-gray-600 leading-relaxed">
                      <p>
                        ...
                        votre agence de confiance pour des voyages
                        inoubliables au Maroc et au-delà. Fondée avec la passion
                        de l&apos;exploration et le désir de partager la beauté
                        de notre monde, Happy Trip s&apos;est donné pour mission
                        de créer des expériences de voyage uniques, authentiques
                        et enrichissantes pour tous nos clients.
                      </p>
