      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div className="text-center mb-12" variants={itemVariants}>
          ...
          <p className="text-lg text-gray-600 mb-6">
            Découvrez ce que nos clients disent de leurs expériences avec{" "}
            {businessName}
          </p>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="relative">
                          ...
                          {filteredReviews[currentIndex].verified && (
                            <div className="absolute -bottom-1 -right-1 bg-[#8EBD22] rounded-full p-1">
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-1 text-gray-500">
                          ...
                          <span className="text-sm">
                            {filteredReviews[currentIndex].helpful} personnes
                            ont trouvé cet avis utile
                          </span>
                        </div>
                      </div>
        ...
        <motion.div className="text-center mt-12" variants={itemVariants}>
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6">
              Partagez votre expérience et aidez d&apos;autres voyageurs à
