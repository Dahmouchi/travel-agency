...
const ResetPassword = (id: any) => {
  ...
  return (
    <div className="w-full mx-auto p-6 bg-white border dark:bg-gray-950 rounded-xl shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <input
                className="w-full rounded-xl border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 py-2.5 pl-10 pr-10 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-primary"
        ...
        <div className="flex justify-end pt-4">
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center px-6 py-2.5 bg-primary hover:bg-primary-dark text-white dark:text-slate-800 font-medium rounded-xl transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
                <svg
