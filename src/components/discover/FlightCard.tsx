...
const FlightCard = ({ img, name, oneway,ville,departure, destination, tourid }: any) => {
  return (
    <div className="featured-flight-items ">
      <div className="featured-image">
      <div className="w-full  bg-amber-600 h-[35vh] rounded-2xl bg-cover bg-center relative" style={{backgroundImage:`url(${img})`}}>
