...
export default function Footer2() {
  return (
    <footer className="border-t border-neutral-200 dark:border-neutral-700 flex justify-center items-center">
      <div className="container max-w-7xl pt-16 pb-8 sm:pt-24 lg:pt-32">
