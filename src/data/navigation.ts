      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              id: "3-1",
              href: "/stay-listings/handle-123",
              name: "Stay listing",
            },
            {
              id: "3-2",
              href: "/car-listings/handle-123",
              name: "Car listing",
            },
            {
              id: "3-3",
              href: "/experience-listings/handle-123",
              name: "Experience listing",
            },
            {
              id: "3-4",
              href: "/real-estate-listings/handle-123",
              name: "Real Estate",
            },
          ],
        },
...
export async function getNavMegaMenu(): Promise<TNavigationItem> {
  ...
  return (
    navigation.find(
      (item) => item.type === "mega-menu" && item.name === "Templates"
    ) || {}
  );
}
