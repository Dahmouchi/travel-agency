          ...
          <div className="relative grid gap-8 bg-white p-7 dark:bg-neutral-800">
            ...
            {notifications.map((item, index) => (
              <CloseButton
                ...
                key={index}
                href={item.href}
                className="relative -m-3 flex rounded-xl p-2 pe-8 transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-hidden focus-visible:ring-3 focus-visible:ring-orange-500/50 dark:hover:bg-gray-700"
              >
