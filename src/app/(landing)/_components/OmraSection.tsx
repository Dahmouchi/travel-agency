          ...
          <div className="lg:w-1/2 lg:py-6">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-gray-600 hover:underline cursor-pointer">
                {tour.type === "NATIONAL" ? "المملكة المغربية" : "رحلة دولية"}
              </span>
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-800 mb-2">الوصف</h2>
              <div
                className={clsx(
      ...
      <div className="bg-white">
        <div className="bg-[#8ebd21] text-white grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 mb-4">
          <div className="flex flex-col lg:hidden items-center px-2 lg:col-span-2 gap-4 bg-[#47663B] text-white py-4 font-semibold">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
              {availableDates.length > 0 ? (
                <div className="relative w-full lg:w-auto">
                  <select
                    ...
                    className="appearance-none text-center bg-white/10 border border-white/20 rounded-full pl-4 pr-8 py-2 text-white focus:outline-none focus:ring-2 focus:ring-white/30 w-full text-base"
                  >
                    {availableDates
              ...
              >
                {availableDates.length > 0 ? "حجز" : "مكتمل"}
              </div>
            </div>
          </div>
          ...
          <div className="flex lg:hidden flex-col gap-2 items-start lg:items-center lg:px-0 px-8 justify-start lg:text-nowrap text-xl md:text-lg lg:justify-center py-4">
            ...
            <div className="md:text-base text-xl w-full text-center font-semibold bg-white/20 px-4 py-1 rounded-full shadow text-white border border-white/30">
              {getNextTourDate || "لا توجد تواريخ"}
            </div>
          </div>
        ...
        <div className="lg:col-span-1 space-y-2 lg:hidden px-2">
          <div className="bg-[#F6F3F2] rounded-lg shadow border border-slate-200 p-4 space-y-4">
            ...
            <div className="flex items-center gap-3 border-b pb-3 justify-between">
              <div className="flex items-center gap-2">
                <span className="text-gray-600 font-medium w-24">الوجهة</span>
              </div>
              <p>
            ...
            <div className="flex items-center gap-3 border-b pb-3 justify-between">
              <div className="flex items-center gap-2">
                <span className="text-gray-600 font-medium w-24">النوع</span>
              </div>
            ...
            <div className="bg-[#F6F3F2] p-6 rounded-lg shadow-sm">
              ...
              <div className="space-y-2">
                {availableDates?.map((item: any, index: any) => (
                  <div
                    key={index}
                    className="grid grid-cols-1 md:grid-cols-4 gap-2 md:gap-4 items-center p-3 md:px-4 rounded border-b-2 border-gray-200 hover:shadow-md transition-shadow"
                  >
                    <div className="text-sm text-gray-700">
                      <span className="md:hidden font-semibold">من: </span>
